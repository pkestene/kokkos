...
struct WorkItemProperty {
  ...
  constexpr static const ImplWorkItemProperty<32>
      ImplForceLocalLaunchNoGridConstant = ImplWorkItemProperty<32>();
  ...
  using ImplForceLocalLaunchNoGridConstant_t = ImplWorkItemProperty<32>;
};
